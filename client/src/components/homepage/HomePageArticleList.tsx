...
const HomePageArticleList = () => {
  ...
  const {
    ...
    data: response,
    error
  } = useQuery<AxiosResponse<Article[], any>, AxiosError>({
    ...
    <>
      <Grid container xs={12}>
        <Grid container xs={12}>
          <Grid item xs={4}>
            <Box>
              <Typography>Created Before</Typography>
              <DatePicker
                onChange={(newValue: Moment | null) => setCreatedBefore(newValue?.format())}
              />
            </Box>
            <Box>
              <Typography>Created After</Typography>
              <DatePicker
                onChange={(newValue: Moment | null) => setCreatedAfter(newValue?.format())}
              />
            </Box>
          </Grid>
          <Grid item xs={4}>
